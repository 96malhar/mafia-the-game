...
func TestEncodeOutbound_AllEventTypes(t *testing.T) {
	...
	all := []game.Event{
		...
		game.NightOpeningStarted{Day: 0, Deadline: 1700000000000},
		game.NightNarrationStarted{Role: game.RoleMafia, Day: 0, Deadline: 1700000000000, Phantom: true},
		game.NightActionStarted{Role: game.RoleMafia, Day: 0, Deadline: 1700000000000},
		game.NightPonderStarted{Role: game.RoleMafia, Day: 0, Deadline: 1700000000000, Phantom: false},
		game.NightSleepStarted{Role: game.RoleMafia, Day: 0, Deadline: 1700000000000},
		game.NightSettleStarted{Role: game.RoleMafia, Day: 0, Deadline: 1700000000000},
